...
@C:/Users/User/Desktop/claude2/.gemini/get-shit-done/references/questioning.md
...
```bash
node "C:/Users/User/Desktop/claude2/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs: capture exploration — {topic_slug}" --files {file_list}
```
