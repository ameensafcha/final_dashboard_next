...
- **Global scope**: `C:/Users/User/Desktop/claude2/.gemini/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/User/Desktop/claude2/.gemini/notes/`)
...
2. Glob `C:/Users/User/Desktop/claude2/.gemini/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/User/Desktop/claude2/.gemini/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/User/Desktop/claude2/.gemini/notes/` — works in any directory
