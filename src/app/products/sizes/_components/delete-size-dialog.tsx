...
export function DeleteSizeDialog({ open, isPending, linkedProducts, onClose, onConfirm }: DeleteSizeDialogProps) {
  return (
      ...
      <DialogContent style={{ backgroundColor: "#FFFFFF", maxWidth: "450px" }}>
        ...
        {linkedProducts.length > 0 ? (
          <div className="space-y-3">
            <p style={{ color: "#DC2626" }}>This size is linked to {linkedProducts.length} product(s). Please delete them first:</p>
          ...
          <p style={{ color: "#1A1A1A" }}>Are you sure you want to delete this size?</p>
        )}
